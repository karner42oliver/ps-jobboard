            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <a class="button button-default inject-message"
                       href="#inject-message"><?php _e("Sende eine Nachricht an dieses Gespräch", mmg()->domain) ?></a>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <table class="table table-striped table-condensed">
                                <thead>
                                <tr>
                                    <th style="width: 10%"><?php _e("Absender", mmg()->domain) ?></th>
                                    <th style="width: 20%"><?php _e("Datum", mmg()->domain) ?></th>
                                    <th style="width: 60%"><?php _e("Inhalt", mmg()->domain) ?></th>
                                    <th style="width: 10%"><?php _e("Aktion", mmg()->domain) ?></th>
                                </tr>
                                </thead>
                                <tbody>
